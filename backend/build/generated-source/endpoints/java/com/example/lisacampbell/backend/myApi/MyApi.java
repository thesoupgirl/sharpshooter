...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public AddPlayer addPlayer(java.lang.String name, java.lang.String byteString) throws java.io.IOException {
    AddPlayer result = new AddPlayer(name, byteString);
    initialize(result);
    return result;
  }
  ...
  public class AddPlayer extends MyApiRequest<com.example.lisacampbell.backend.myApi.model.Player> {
    ...
    private static final String REST_PATH = "addPlayer/{name}/{byteString}";
     ...
     * @since 1.13
     */
    protected AddPlayer(java.lang.String name, java.lang.String byteString) {
