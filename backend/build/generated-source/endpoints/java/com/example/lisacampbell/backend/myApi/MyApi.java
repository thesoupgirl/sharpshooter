...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public AddPlayer addPlayer(java.lang.String name) throws java.io.IOException {
    AddPlayer result = new AddPlayer(name);
    initialize(result);
    return result;
  }
  ...
  public class AddPlayer extends MyApiRequest<com.example.lisacampbell.backend.myApi.model.Player> {
    ...
    private static final String REST_PATH = "addPlayer/{name}";
     ...
     * @since 1.13
     */
    protected AddPlayer(java.lang.String name) {
   ...
   * @return the request
   */
  public AttemptKill attemptKill(java.lang.String killerId, java.lang.String imageBytes) throws java.io.IOException {
    AttemptKill result = new AttemptKill(killerId, imageBytes);
    initialize(result);
    return result;
  }
  ...
  public class AttemptKill extends MyApiRequest<com.example.lisacampbell.backend.myApi.model.BooleanResponse> {
    ...
    private static final String REST_PATH = "attemptKill/{killerId}/{imageBytes}";
     ...
     * @since 1.13
     */
    protected AttemptKill(java.lang.String killerId, java.lang.String imageBytes) {
      ...
      this.imageBytes = com.google.api.client.util.Preconditions.checkNotNull(imageBytes, "Required parameter imageBytes must be specified.");
    }
    ...
    public AttemptKill setImageBytes(java.lang.String imageBytes) {
  ...
  /**
   * Create a request for the method "kill".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link Kill#execute()} method to invoke the remote operation.
   *
   * @param killerId
   * @return the request
   */
  public Kill kill(java.lang.String killerId) throws java.io.IOException {
    Kill result = new Kill(killerId);
    initialize(result);
    return result;
  }

  public class Kill extends MyApiRequest<com.example.lisacampbell.backend.myApi.model.BooleanResponse> {

    private static final String REST_PATH = "kill/{killerId}";

    /**
     * Create a request for the method "kill".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link Kill#execute()} method to invoke the remote operation. <p> {@link
     * Kill#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must be
     * called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param killerId
     * @since 1.13
     */
    protected Kill(java.lang.String killerId) {
      super(MyApi.this, "DELETE", REST_PATH, null, com.example.lisacampbell.backend.myApi.model.BooleanResponse.class);
      this.killerId = com.google.api.client.util.Preconditions.checkNotNull(killerId, "Required parameter killerId must be specified.");
    }

    @Override
    public Kill setAlt(java.lang.String alt) {
      return (Kill) super.setAlt(alt);
    }

    @Override
    public Kill setFields(java.lang.String fields) {
      return (Kill) super.setFields(fields);
    }

    @Override
    public Kill setKey(java.lang.String key) {
      return (Kill) super.setKey(key);
    }

    @Override
    public Kill setOauthToken(java.lang.String oauthToken) {
      return (Kill) super.setOauthToken(oauthToken);
    }

    @Override
    public Kill setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (Kill) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public Kill setQuotaUser(java.lang.String quotaUser) {
      return (Kill) super.setQuotaUser(quotaUser);
    }

    @Override
    public Kill setUserIp(java.lang.String userIp) {
      return (Kill) super.setUserIp(userIp);
    }
    ...
    public Kill setKillerId(java.lang.String killerId) {
      this.killerId = killerId;
      return this;
    }

    @Override
    public Kill set(String parameterName, Object value) {
      return (Kill) super.set(parameterName, value);
    }
  }
