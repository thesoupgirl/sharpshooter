...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "playerAlive".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link PlayerAlive#execute()} method to invoke the remote operation.
   *
   * @param playerId
   * @return the request
   */
  public PlayerAlive playerAlive(java.lang.String playerId) throws java.io.IOException {
    PlayerAlive result = new PlayerAlive(playerId);
    initialize(result);
    return result;
  }

  public class PlayerAlive extends MyApiRequest<com.example.lisacampbell.backend.myApi.model.BooleanResponse> {

    private static final String REST_PATH = "checkPlayerAlive/{playerId}";

    /**
     * Create a request for the method "playerAlive".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link PlayerAlive#execute()} method to invoke the remote operation. <p>
     * {@link
     * PlayerAlive#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param playerId
     * @since 1.13
     */
    protected PlayerAlive(java.lang.String playerId) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.lisacampbell.backend.myApi.model.BooleanResponse.class);
      this.playerId = com.google.api.client.util.Preconditions.checkNotNull(playerId, "Required parameter playerId must be specified.");
    }
    ...
    @Override
    public PlayerAlive setAlt(java.lang.String alt) {
      return (PlayerAlive) super.setAlt(alt);
    }

    @Override
    public PlayerAlive setFields(java.lang.String fields) {
      return (PlayerAlive) super.setFields(fields);
    }

    @Override
    public PlayerAlive setKey(java.lang.String key) {
      return (PlayerAlive) super.setKey(key);
    }

    @Override
    public PlayerAlive setOauthToken(java.lang.String oauthToken) {
      return (PlayerAlive) super.setOauthToken(oauthToken);
    }

    @Override
    public PlayerAlive setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (PlayerAlive) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public PlayerAlive setQuotaUser(java.lang.String quotaUser) {
      return (PlayerAlive) super.setQuotaUser(quotaUser);
    }

    @Override
    public PlayerAlive setUserIp(java.lang.String userIp) {
      return (PlayerAlive) super.setUserIp(userIp);
    }
    ...
    public PlayerAlive setPlayerId(java.lang.String playerId) {
      this.playerId = playerId;
      return this;
    }

    @Override
    public PlayerAlive set(String parameterName, Object value) {
      return (PlayerAlive) super.set(parameterName, value);
    }
  }
