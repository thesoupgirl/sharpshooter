 ...
 */
@Api(name = "messaging", version = "v1", namespace = @ApiNamespace(ownerDomain = "server.lisacampbell.example.com", ownerName = "server.lisacampbell.example.com", packagePath = ""))
